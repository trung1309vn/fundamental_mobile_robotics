...
#---------------------------------------------------------------------
def compute_control_input(desired_state, robot_state, current_time, k_gain):
    ...
    # current_input[2] = 2.
    goal_vel = np.array([2*np.sin(current_time), np.cos(current_time), 0])
    current_input = k_gain*state_diff + goal_vel
...
def simulate_control():
    ...
    for it in range(sim_iter):
        ...
        #------------------------------------------------------------
        # current_input = compute_control_input(desired_state, robot_state, current_time, True, 2.5, None, None)
        current_input = compute_control_input(desired_state, robot_state, current_time, 1.5)
        #------------------------------------------------------------
        ...
        desired_state = np.array([-2*np.cos(current_time), np.sin(current_time), 0])
